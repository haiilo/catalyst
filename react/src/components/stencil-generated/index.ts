...
export const CatDateInline = /*@__PURE__*/createReactComponent<JSX.CatDateInline, HTMLCatDateInlineElement>('cat-date-inline');
...
export const CatSegment = /*@__PURE__*/createReactComponent<JSX.CatSegment, HTMLCatSegmentElement>('cat-segment');
export const CatSegmentedControl = /*@__PURE__*/createReactComponent<JSX.CatSegmentedControl, HTMLCatSegmentedControlElement>('cat-segmented-control');
