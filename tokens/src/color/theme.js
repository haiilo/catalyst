  ...
  color: {
    theme: {
      ...
      secondary: {
        ...
        fill: { value: '{color.base.neutral.0}', attributes: { cssProp: "secondary-fill" } },
        fillHover: { value: '{color.base.neutral.0}', attributes: { cssProp: "secondary-fill-hover" } },
        fillActive: { value: '{color.base.neutral.0}', attributes: { cssProp: "secondary-fill-active" } },
        text: { value: '{color.base.neutral.900}', attributes: { cssProp: "secondary-text" } },
        textHover: { value: '{color.base.neutral.900}', attributes: { cssProp: "secondary-text-hover" } },
        textActive: { value: '{color.base.neutral.900}', attributes: { cssProp: "catsecondary-text-active" } }
      },
      success: {
        ...
        fill: { value: '{color.base.neutral.0}', attributes: { cssProp: "success-fill" } },
        fillHover: { value: '{color.base.neutral.0}', attributes: { cssProp: "success-fill-hover" } },
        fillActive: { value: '{color.base.neutral.0}', attributes: { cssProp: "success-fill-active" } },
      ...
      warning: {
        ...
        fill: { value: '{color.base.neutral.900}', attributes: { cssProp: "warning-fill" } },
        fillHover: { value: '{color.base.neutral.900}', attributes: { cssProp: "warning-fill-hover" } },
        fillActive: { value: '{color.base.neutral.900}', attributes: { cssProp: "warning-fill-active" } },
      ...
      danger: {
        ...
        fill: { value: '{color.base.neutral.0}', attributes: { cssProp: "danger-fill" } },
        fillHover: { value: '{color.base.neutral.0}', attributes: { cssProp: "danger-fill-hover" } },
        fillActive: { value: '{color.base.neutral.0}', attributes: { cssProp: "danger-fill-active" } },
        ...
        textActive: { value: '{color.base.red.600}', attributes: { cssProp: "catdanger-text-active" } }
      }
    }
  }
}
