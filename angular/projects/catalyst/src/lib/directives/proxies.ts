...
@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['a11yCurrent', 'a11yLabel', 'active', 'buttonAttributes', 'buttonId', 'color', 'disabled', 'icon', 'iconOnly', 'iconRight', 'iconSrc', 'loading', 'name', 'noEllipsis', 'round', 'size', 'submit', 'url', 'urlTarget', 'value', 'variant'],
...
@ProxyCmp({
  defineCustomElementFn: undefined,
  inputs: ['autoComplete', 'clearable', 'disableValidation', 'disabled', 'errors', 'hint', 'icon', 'iconRight', 'identifier', 'inputAttributes', 'invalid', 'label', 'labelHidden', 'max', 'maxLength', 'min', 'minLength', 'name', 'placeholder', 'readonly', 'required', 'requiredMarker', 'round', 'textPrefix', 'textSuffix', 'type', 'value'],
