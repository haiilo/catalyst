...
@ProxyCmp({
  ...
  inputs: ['a11yControls', 'a11yDescribedBy', 'a11yLabel', 'a11yOwns', 'appearance', 'buttonId', 'color', 'disabled', 'ellipsed', 'icon', 'iconOnly', 'iconSuffix', 'inactive', 'loading', 'name', 'round', 'size', 'submit', 'url', 'urlTarget', 'value'],
  methods: ['setFocus']
})
@Component({
  selector: 'cat-button',
