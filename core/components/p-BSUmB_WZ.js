...
function getConfig(options, more = {}) {
    ...
    const plugins = options.mode === 'week' ? [new weekSelectPlugin({})] : [];
...
export { getFormat as a, getLocale as b, flatpickr as f, getConfig as g };
//# sourceMappingURL=p-BSUmB_WZ.js.map
