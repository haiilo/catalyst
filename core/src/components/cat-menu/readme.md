...
| `triggerIconOnly`         | `trigger-icon-only`    | Show only the icon in the trigger button.                                                                                                                                                            | `"l" \| "m" \| "s" \| "xl" \| "xs" \| boolean`                                                                                                                       | `false`          |
| `triggerLabel`            | `trigger-label`        | The trigger button label.                                                                                                                                                                            | `string`                                                                                                                                                             | `''`             |
