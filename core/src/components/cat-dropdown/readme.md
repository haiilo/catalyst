...
| `focusTrap`          | `focus-trap`           | Whether the focus should be trapped inside dropdown popup. Use it only when the dropdown popup content has role dialog.                                                                              | `boolean`                                                                                                                                                            | `false`          |
