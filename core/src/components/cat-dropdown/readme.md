...
| -------------------- | ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `arrowNavigation`    | `arrow-navigation`     | <span style="color:red">**[DEPRECATED]**</span> use cat-menu<br/><br/>Do not navigate focus inside the dropdown via vertical arrow keys.                                                                                                                                                                                                                                                                                                                                                                 | `"horizontal" \| "none" \| "vertical"`                                                                                                                               | `'vertical'`     |
...
| `noReturnFocus`      | `no-return-focus`      | <span style="color:red">**[DEPRECATED]**</span> the property can be removed, focus is arranged internally<br/><br/>Trigger element will not receive focus when dropdown is closed.                                                                                                                                                                                                                                                                                                                       | `boolean`                                                                                                                                                            | `false`          |
