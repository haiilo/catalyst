...
| `disableInitialFocus` | `disable-initial-focus` | No element in dropdown will receive focus when dropdown is open. By default, the first element in tab order will receive a focus.      | `boolean`                                                                                                                                                            | `false`          |
