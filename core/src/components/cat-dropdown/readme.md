...
| `noReturnFocus`      | `no-return-focus`      | Trigger element will not receive focus when dropdown is closed. Please use this property carefully, consider using cat-menu over using this property                                                                                                                                                                                                                                                                                                                                                     | `boolean`                                                                                                                                                            | `false`          |
