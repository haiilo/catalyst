...
| `dateMaskOptions`  | --                | Activates cleave-zen date mask on input                                                                                                                                                                                                                                                                                         | `FormatDateMaskOptions \| undefined`                                                                        | `undefined`  |
...
| `timeMaskOptions`  | --                | Activates cleave-zen time mask on input                                                                                                                                                                                                                                                                                         | `FormatTimeMaskOptions \| undefined`                                                                        | `undefined`  |
