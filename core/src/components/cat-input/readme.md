...
| `max`              | `max`             | A maximum value for time and numeric values.                                                                                                                                                                                                                                                                                    | `number \| string \| undefined`                                                                             | `undefined`  |
| `maxLength`        | `max-length`      | A maximum length (number of characters) for textual values.                                                                                                                                                                                                                                                                     | `number \| undefined`                                                                                       | `undefined`  |
| `min`              | `min`             | A minimum value for time and numeric values.                                                                                                                                                                                                                                                                                    | `number \| string \| undefined`                                                                             | `undefined`  |
