...
| ------------------ | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------ |
| `accept`           | `accept`            | Defines the file types the file input should accept.                                                                                                                                                                                                                                                                            | `string \| undefined`                                                                                       | `undefined`  |
...
| `dateMaskOptions`  | `date-mask-options` | Activates cleave-zen date mask on input                                                                                                                                                                                                                                                                                         | `FormatDateMaskOptions \| undefined`                                                                        | `undefined`  |
...
| `multiple`         | `multiple`          | Whether the input should allow multiple files to be selected.                                                                                                                                                                                                                                                                   | `boolean \| undefined`                                                                                      | `undefined`  |
...
| `timeMaskOptions`  | `time-mask-options` | Activates cleave-zen time mask on input                                                                                                                                                                                                                                                                                         | `FormatTimeMaskOptions \| undefined`                                                                        | `undefined`  |
