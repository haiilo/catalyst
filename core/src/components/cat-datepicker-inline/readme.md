...
| `nativePickerAttributes` | `native-picker-attributes` | Attributes that will be added to the rendered HTML datepicker element.                   | `undefined \| { [key: string]: string; }`                 | `undefined` |
