...
| `mode`             | `mode`            | The mode of the datepicker, to select a date, time, both or a week number.                                                                                                                                                                                                                                                      | `"date" \| "datetime" \| "time" \| "week"`                                    | `'date'`     |
...
graph TD;
  ...
  style cat-datepicker-flat fill:#f9f,stroke:#333,stroke-width:4px
```
