...
| `appearance`      | `appearance`          | The rendering style of the button.                                                                                                                                                                                 | `"filled" \| "outlined" \| "text"`  | `'filled'`    |
...
| `iconOnly`        | `icon-only`           | Hide the actual button content and only display the icon.                                                                                                                                                          | `boolean`                           | `false`       |
