...
| ----------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- | ------------- |
| `a11yControls`    | `a11y-controls`     | Use this property to add an `aria-controls` attribute to the button. Use the attribute to point to the unique ID of the content that the button manages.                                                           | `string \| undefined`                                           | `undefined`   |
| `a11yDescribedBy` | `a11y-described-by` | Indicates the ID of a component that describes the button.                                                                                                                                                         | `string \| undefined`                                           | `undefined`   |
...
| `a11yOwns`        | `a11y-owns`         | Indicates the ID of a component owned by the button.                                                                                                                                                               | `string \| undefined`                                           | `undefined`   |
...
| `color`           | `color`             | The color palette of the button.                                                                                                                                                                                   | `"error" \| "primary" \| "secondary" \| "success" \| "warning"` | `'secondary'` |
...
| `round`           | `round`             | Use round button edges. Defaults to false unless `iconOnly` is set.                                                                                                                                                | `boolean \| undefined`                                          | `undefined`   |
...
| `variant`         | `variant`           | The rendering style of the button.                                                                                                                                                                                 | `"filled" \| "outlined" \| "text"`                              | `'filled'`    |
