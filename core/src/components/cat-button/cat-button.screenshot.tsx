...
describe('cat-button', () => {
  ...
  it('size xs', async () => {
    const { root } = await render(<cat-button size="xs">XSmall</cat-button>);
    await expect(root).toMatchScreenshot();
  });

  it('size s', async () => {
    const { root } = await render(<cat-button size="s">Small</cat-button>);
    await expect(root).toMatchScreenshot();
  });

  it('size m', async () => {
    const { root } = await render(<cat-button size="m">Medium</cat-button>);
    await expect(root).toMatchScreenshot();
  });

  it('size l', async () => {
    const { root } = await render(<cat-button size="l">Large</cat-button>);
    await expect(root).toMatchScreenshot();
  });

  it('size xl', async () => {
    const { root } = await render(<cat-button size="xl">XLarge</cat-button>);
    await expect(root).toMatchScreenshot();
  });

  it('loading', async () => {
    const { root } = await render(<cat-button loading>Loading</cat-button>);
    await expect(root).toMatchScreenshot();
  });

  it('with icon left', async () => {
    const { root } = await render(<cat-button icon="$cat:select-open">With Icon</cat-button>);
    await expect(root).toMatchScreenshot();
  });
  ...
  it('as link with url', async () => {
    const { root } = await render(<cat-button url="https://example.com">Link Button</cat-button>);
    await expect(root).toMatchScreenshot();
  });
});
