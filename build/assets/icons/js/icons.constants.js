...
export const ci16ChevronDown = {
    ...
    data: `<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.47 5.47a.75.75 0 0 1 1.06 0L8 8.94l3.47-3.47a.75.75 0 1 1 1.06 1.06l-4 4a.75.75 0 0 1-1.06 0l-4-4a.75.75 0 0 1 0-1.06Z"/></svg>`
};
export const ci16ChevronLeft = {
    name: '16-chevron-left',
    data: `<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.53 3.47a.75.75 0 0 1 0 1.06L7.06 8l3.47 3.47a.75.75 0 1 1-1.06 1.06l-4-4a.75.75 0 0 1 0-1.06l4-4a.75.75 0 0 1 1.06 0Z"/></svg>`
};
export const ci16ChevronRight = {
    name: '16-chevron-right',
    data: `<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.47 3.47a.75.75 0 0 1 1.06 0l4 4a.75.75 0 0 1 0 1.06l-4 4a.75.75 0 0 1-1.06-1.06L8.94 8 5.47 4.53a.75.75 0 0 1 0-1.06Z"/></svg>`
};
...
export const ci16EditorH6 = {
    name: '16-editor-h-6',
    data: `<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M1.75 3a.75.75 0 0 0-1.5 0v10a.75.75 0 0 0 1.5 0V8.75h5.5V13a.75.75 0 0 0 1.5 0V3a.75.75 0 0 0-1.5 0v4.25h-5.5V3Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M13.62 9.385c-.287 0-.547.043-.78.13l.19-.22 2.16-2.58h-1.38c-.187 0-.354.035-.5.105a.937.937 0 0 0-.33.25l-1.64 2.215c-.554.74-.83 1.468-.83 2.185 0 .383.058.735.174 1.055.12.32.292.595.515.825.227.23.502.41.825.54.324.127.689.19 1.095.19.397 0 .759-.067 1.085-.2a2.54 2.54 0 0 0 .835-.54c.234-.23.414-.497.54-.8.127-.307.19-.63.19-.97 0-.373-.063-.697-.19-.97a1.969 1.969 0 0 0-.49-.685 1.992 1.992 0 0 0-.69-.4 2.424 2.424 0 0 0-.78-.13Zm-.086 3.38c-.136.06-.285.09-.445.09a1.34 1.34 0 0 1-.485-.08.9.9 0 0 1-.34-.24.992.992 0 0 1-.2-.37A1.675 1.675 0 0 1 12 11.68c0-.18.027-.342.08-.485.054-.143.127-.267.22-.37a.96.96 0 0 1 .34-.235c.13-.057.274-.085.43-.085.173 0 .33.027.47.08.143.053.265.13.365.23.1.1.177.223.23.37.057.147.085.313.085.5 0 .167-.03.322-.09.465-.056.14-.135.263-.235.37a1.1 1.1 0 0 1-.36.245Z"/></svg>`
};
export const ci16EditorHeadline = {
    name: '16-editor-headline',
    data: `<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M3 1.25a.75.75 0 0 1 .75.75v5.25h8.5V2a.75.75 0 0 1 1.5 0v12a.75.75 0 0 1-1.5 0V8.75h-8.5V14a.75.75 0 0 1-1.5 0V2A.75.75 0 0 1 3 1.25Z"/></svg>`
};
export const ci16EditorIndentDecrease = {
    name: '16-editor-indent-decrease',
    data: `<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M1.25 2A.75.75 0 0 1 2 1.25h12a.75.75 0 0 1 0 1.5H2A.75.75 0 0 1 1.25 2Zm3.22 3.47a.75.75 0 0 1 1.06 1.06L4.06 8l1.47 1.47a.75.75 0 1 1-1.06 1.06l-2-2a.75.75 0 0 1 0-1.06l2-2ZM8.25 6A.75.75 0 0 1 9 5.25h5a.75.75 0 0 1 0 1.5H9A.75.75 0 0 1 8.25 6Zm0 4A.75.75 0 0 1 9 9.25h5a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1-.75-.75ZM2 13.25a.75.75 0 0 0 0 1.5h12a.75.75 0 0 0 0-1.5H2Z"/></svg>`
};
...
export const ciBellRingingFilled = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7.3 3.905A6.725 6.725 0 0 1 12 2c1.756 0 3.447.681 4.7 1.905a6.493 6.493 0 0 1 1.965 4.645c0 3.63.882 5.751 1.61 6.89.341.532.239 1.179.056 1.595-.18.409-.608.965-1.304.965H4.973c-.695 0-1.124-.556-1.304-.965-.183-.416-.285-1.063.055-1.595.729-1.139 1.611-3.26 1.611-6.89 0-1.75.712-3.42 1.965-4.645ZM4.731 5.098a.75.75 0 1 0-1.321-.71 9.75 9.75 0 0 0-1.153 4.984.75.75 0 0 0 1.499-.057 8.25 8.25 0 0 1 .975-4.217Zm14.538 0a.75.75 0 0 1 1.321-.71 9.75 9.75 0 0 1 1.153 4.984.75.75 0 0 1-1.499-.057 8.25 8.25 0 0 0-.975-4.217ZM10.662 19.5a.75.75 0 0 0-1.289.766c.27.453.655.827 1.116 1.086a3.086 3.086 0 0 0 3.022 0 3.02 3.02 0 0 0 1.116-1.086.75.75 0 0 0-1.29-.767 1.514 1.514 0 0 1-.56.545 1.587 1.587 0 0 1-1.553 0 1.514 1.514 0 0 1-.562-.545Z"/></svg>`
};
export const ciBellRingingOutlined = {
    name: 'bell-ringing-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.978 8.96a7.029 7.029 0 0 1 14.044 0l.124 2.733a6.949 6.949 0 0 0 1.287 3.723l.05.07c.826 1.157-.001 2.764-1.423 2.764H4.94c-1.422 0-2.25-1.607-1.423-2.765l.05-.07a6.948 6.948 0 0 0 1.287-3.722l.124-2.733ZM12 3.75a5.529 5.529 0 0 0-5.523 5.278l-.124 2.733a8.449 8.449 0 0 1-1.565 4.527l-.05.07a.248.248 0 0 0 .202.392h14.12c.202 0 .32-.228.202-.393l-.05-.07a8.45 8.45 0 0 1-1.565-4.526l-.124-2.733A5.529 5.529 0 0 0 12 3.75Z"/><path d="M4.731 5.098a.75.75 0 1 0-1.321-.71 9.75 9.75 0 0 0-1.153 4.984.75.75 0 1 0 1.499-.057 8.25 8.25 0 0 1 .975-4.217Zm14.538 0a.75.75 0 0 1 1.321-.71 9.75 9.75 0 0 1 1.153 4.984.75.75 0 1 1-1.499-.057 8.25 8.25 0 0 0-.975-4.217ZM10.323 19.5a.75.75 0 0 0-1.118 1A3.742 3.742 0 0 0 12 21.75c1.11 0 2.11-.484 2.795-1.25a.75.75 0 0 0-1.118-1 2.243 2.243 0 0 1-1.677.75 2.243 2.243 0 0 1-1.677-.75Z"/></svg>`
};
export const ciBookFilled = {
    name: 'book-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M11 3.779c-3.09-.881-5.15-.85-8.313.123A.981.981 0 0 0 2 4.844v13.773c0 .681.667 1.16 1.325.983 2.866-.773 4.847-.644 7.675.117V3.779Zm2 15.971c2.95-.696 4.931-.73 7.725-.078.644.15 1.275-.326 1.275-.988V4.826a.977.977 0 0 0-.666-.933c-3.171-1.04-5.24-.959-8.334-.101V19.75Z"/></svg>`
};
export const ciBookOutlined = {
    name: 'book-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M20.555 4.065c-1.616-.513-2.965-.729-4.354-.676-1.316.05-2.632.34-4.195.798-1.575-.485-2.891-.759-4.208-.792-1.383-.034-2.722.198-4.319.674A1.73 1.73 0 0 0 2.25 5.731v11.895c0 1.204 1.16 1.996 2.256 1.715 2.626-.674 4.356-.47 7.285.38a.75.75 0 0 0 .396.005c3.045-.786 4.8-.886 7.38-.31 1.085.241 2.183-.558 2.183-1.725V5.713c0-.737-.466-1.417-1.195-1.648ZM12.75 5.533c1.365-.386 2.454-.606 3.508-.646 1.177-.044 2.35.134 3.843.608.08.025.149.107.149.218v11.978c0 .152-.155.305-.357.26-2.575-.574-4.454-.526-7.144.093l.001-12.51Zm-1.5-.007c-1.356-.4-2.44-.605-3.49-.631-1.176-.03-2.35.164-3.852.612a.23.23 0 0 0-.158.224v11.895c0 .152.165.318.383.262 2.657-.682 4.55-.546 7.117.126V5.526Z"/></svg>`
};
export const ciBookmarkCheckOutlined = {
    name: 'bookmark-check-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7 3.25A2.75 2.75 0 0 0 4.25 6v14a.75.75 0 0 0 1.081.673L12 17.39l6.669 3.282A.75.75 0 0 0 19.75 20v-5a.75.75 0 0 0-1.5 0v3.795l-5.919-2.912a.75.75 0 0 0-.662 0L5.75 18.795V6c0-.69.56-1.25 1.25-1.25h6a.75.75 0 0 0 0-1.5H7Z"/><path d="M19.609 6.438a.75.75 0 0 0-1.218-.876l-3.13 4.346-1.78-1.484a.75.75 0 1 0-.961 1.152l2.4 2a.75.75 0 0 0 1.089-.138l3.6-5Z"/></svg>`
};
export const ciBookmarkFilled = {
    name: 'bookmark-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M17 3H7a3 3 0 0 0-3 3v13.404a1 1 0 0 0 1.436.9l6.128-2.968a1 1 0 0 1 .872 0l6.128 2.969a1 1 0 0 0 1.436-.9V6a3 3 0 0 0-3-3Z"/></svg>`
};
export const ciBookmarkOutlined = {
    name: 'bookmark-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.25 6A2.75 2.75 0 0 1 7 3.25h10A2.75 2.75 0 0 1 19.75 6v14a.75.75 0 0 1-1.081.673L12 17.39l-6.669 3.282A.75.75 0 0 1 4.25 20V6ZM7 4.75c-.69 0-1.25.56-1.25 1.25v12.795l5.919-2.912a.75.75 0 0 1 .662 0l5.919 2.912V6c0-.69-.56-1.25-1.25-1.25H7Z"/></svg>`
};
...
export const ciChatFilled = {
    name: 'chat-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20 12a8 8 0 0 1-12.235 6.788L4 20l1.212-3.765A8 8 0 1 1 20 12Z"/></svg>`
};
export const ciChatOutlined = {
    name: 'chat-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 4.75a7.25 7.25 0 0 0-6.152 11.088l.185.295-.871 2.705 2.705-.87.295.184A7.25 7.25 0 1 0 12 4.75ZM3.25 12a8.75 8.75 0 1 1 4.422 7.606l-2.978.959a1 1 0 0 1-1.259-1.259l.959-2.978A8.714 8.714 0 0 1 3.25 12Z"/></svg>`
};
export const ciCheckCircleFilled = {
    name: 'check-circle-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Zm4.768-12.36a1 1 0 1 0-1.536-1.28l-4.3 5.159-2.225-2.226a1 1 0 0 0-1.414 1.414l3 3a1 1 0 0 0 1.475-.067l5-6Z"/></svg>`
};
export const ciCheckCircleOutlined = {
    name: 'check-circle-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16.576 9.48a.75.75 0 0 0-1.152-.96l-4.474 5.369-2.42-2.42a.75.75 0 0 0-1.06 1.061l3 3a.75.75 0 0 0 1.106-.05l5-6Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM3.75 12a8.25 8.25 0 1 1 16.5 0 8.25 8.25 0 0 1-16.5 0Z"/></svg>`
};
export const ciCheckOutlined = {
    name: 'check-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.45 6.4a.75.75 0 0 1 .15 1.05l-7.5 10a.75.75 0 0 1-1.157.052l-4.5-5a.75.75 0 1 1 1.114-1.004l3.89 4.322L17.4 6.55a.75.75 0 0 1 1.05-.15Z"/></svg>`
};
export const ciChevronDownOutlined = {
    name: 'chevron-down-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.47 9.47a.75.75 0 0 1 1.06 0L12 13.94l4.47-4.47a.75.75 0 1 1 1.06 1.06l-5 5a.75.75 0 0 1-1.06 0l-5-5a.75.75 0 0 1 0-1.06Z"/></svg>`
};
export const ciChevronLeftOutlined = {
    name: 'chevron-left-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.53 6.47a.75.75 0 0 1 0 1.06L10.06 12l4.47 4.47a.75.75 0 1 1-1.06 1.06l-5-5a.75.75 0 0 1 0-1.06l5-5a.75.75 0 0 1 1.06 0Z"/></svg>`
};
export const ciChevronRightOutlined = {
    name: 'chevron-right-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M9.47 6.47a.75.75 0 0 1 1.06 0l5 5a.75.75 0 0 1 0 1.06l-5 5a.75.75 0 1 1-1.06-1.06L13.94 12 9.47 7.53a.75.75 0 0 1 0-1.06Z"/></svg>`
};
export const ciChevronUpOutlined = {
    name: 'chevron-up-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11.47 8.47a.75.75 0 0 1 1.06 0l5 5a.75.75 0 1 1-1.06 1.06L12 10.06l-4.47 4.47a.75.75 0 0 1-1.06-1.06l5-5Z"/></svg>`
};
export const ciClockFilled = {
    name: 'clock-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Zm1-15a1 1 0 1 0-2 0v5a1 1 0 0 0 1 1h5a1 1 0 1 0 0-2h-4V7Z"/></svg>`
};
export const ciClockOutlined = {
    name: 'clock-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12.75 7a.75.75 0 0 0-1.5 0v5c0 .414.336.75.75.75h5a.75.75 0 0 0 0-1.5h-4.25V7Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM3.75 12a8.25 8.25 0 1 1 16.5 0 8.25 8.25 0 0 1-16.5 0Z"/></svg>`
};
...
export const ciCommunitiesOutlined = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 4.75a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5ZM9.25 6a2.75 2.75 0 1 1 5.5 0 2.75 2.75 0 0 1-5.5 0Zm-4.5 6a1.25 1.25 0 1 1 2.5 0 1.25 1.25 0 0 1-2.5 0ZM6 9.25a2.75 2.75 0 1 0 0 5.5 2.75 2.75 0 0 0 0-5.5ZM10.75 18a1.25 1.25 0 1 1 2.5 0 1.25 1.25 0 0 1-2.5 0ZM12 15.25a2.75 2.75 0 1 0 0 5.5 2.75 2.75 0 0 0 0-5.5ZM16.75 12a1.25 1.25 0 1 1 2.5 0 1.25 1.25 0 0 1-2.5 0ZM18 9.25a2.75 2.75 0 1 0 0 5.5 2.75 2.75 0 0 0 0-5.5Z"/></svg>`
};
export const ciContentFilled = {
    name: 'content-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M6 3a3 3 0 0 0-3 3v2h5V3H6Zm4 0v5h11V6a3 3 0 0 0-3-3h-8Zm11 7H10v11h8a3 3 0 0 0 3-3v-8ZM8 21V10H3v8a3 3 0 0 0 3 3h2Z"/></svg>`
};
export const ciContentOutlined = {
    name: 'content-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6 3.25A2.75 2.75 0 0 0 3.25 6v12A2.75 2.75 0 0 0 6 20.75h12A2.75 2.75 0 0 0 20.75 18V6A2.75 2.75 0 0 0 18 3.25H6Zm2.25 1.5H6c-.69 0-1.25.56-1.25 1.25v2.25h3.5v-3.5Zm-3.5 5V18c0 .69.56 1.25 1.25 1.25h2.25v-9.5h-3.5Zm5 9.5H18c.69 0 1.25-.56 1.25-1.25V9.75h-9.5v9.5Zm9.5-11h-9.5v-3.5H18c.69 0 1.25.56 1.25 1.25v2.25Z"/></svg>`
};
export const ciCrossCircleFilled = {
    name: 'cross-circle-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10ZM8.293 8.293a1 1 0 0 1 1.414 0L12 10.586l2.293-2.293a1 1 0 1 1 1.414 1.414L13.414 12l2.293 2.293a1 1 0 0 1-1.414 1.414L12 13.414l-2.293 2.293a1 1 0 0 1-1.414-1.414L10.586 12 8.293 9.707a1 1 0 0 1 0-1.414Z"/></svg>`
};
...
export const ciCrossOutlined = {
    name: 'cross-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7.53 6.47a.75.75 0 0 0-1.06 1.06L10.94 12l-4.47 4.47a.75.75 0 1 0 1.06 1.06L12 13.06l4.47 4.47a.75.75 0 1 0 1.06-1.06L13.06 12l4.47-4.47a.75.75 0 0 0-1.06-1.06L12 10.94 7.53 6.47Z"/></svg>`
};
export const ciCrossSquareFilled = {
    name: 'cross-square-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5 3a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5Zm3.293 5.293a1 1 0 0 1 1.414 0L12 10.586l2.293-2.293a1 1 0 1 1 1.414 1.414L13.414 12l2.293 2.293a1 1 0 0 1-1.414 1.414L12 13.414l-2.293 2.293a1 1 0 0 1-1.414-1.414L10.586 12 8.293 9.707a1 1 0 0 1 0-1.414Z"/></svg>`
};
...
export const ciDangerFilled = {
    name: 'danger-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 3.25c-.429 0-.85.113-1.22.328a2.5 2.5 0 0 0-.899.891L2.577 16.981a2.554 2.554 0 0 0-.007 2.491c.212.381.519.7.891.926a2.44 2.44 0 0 0 1.234.352h14.61a2.44 2.44 0 0 0 1.233-.352 2.5 2.5 0 0 0 .892-.926 2.553 2.553 0 0 0-.007-2.491L14.119 4.469a2.494 2.494 0 0 0-.899-.891A2.439 2.439 0 0 0 12 3.25ZM12 8a1 1 0 0 1 1 1v3.5a1 1 0 1 1-2 0V9a1 1 0 0 1 1-1Zm1 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"/></svg>`
};
export const ciDangerOutlined = {
    name: 'danger-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 8.25a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0V9a.75.75 0 0 1 .75-.75ZM13 16a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 3.25c-.429 0-.85.113-1.22.328a2.5 2.5 0 0 0-.899.891L2.577 16.981a2.554 2.554 0 0 0-.007 2.491c.212.381.519.7.891.926a2.44 2.44 0 0 0 1.234.352h14.61a2.44 2.44 0 0 0 1.233-.352 2.5 2.5 0 0 0 .892-.926 2.553 2.553 0 0 0-.007-2.491L14.119 4.469a2.494 2.494 0 0 0-.899-.891A2.439 2.439 0 0 0 12 3.25Zm-.826 1.981a.995.995 0 0 1 .356-.354.94.94 0 0 1 .94 0 .995.995 0 0 1 .356.354l7.292 12.49a1.053 1.053 0 0 1 0 1.023.997.997 0 0 1-.355.37.941.941 0 0 1-.472.136H4.71a.94.94 0 0 1-.472-.136.997.997 0 0 1-.355-.37 1.054 1.054 0 0 1 0-1.023l7.292-12.49Z"/></svg>`
};
...
export const ciEarthOutlined = {
    name: 'earth-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.057 19.641a.747.747 0 0 1-.114.089A9.707 9.707 0 0 1 12 21.75c-5.385 0-9.75-4.365-9.75-9.75S6.615 2.25 12 2.25s9.75 4.365 9.75 9.75a9.776 9.776 0 0 1-.775 3.816 9.781 9.781 0 0 1-2.918 3.825ZM12 3.75A8.25 8.25 0 0 0 4.84 16.1l.337-.337a.25.25 0 0 0 .073-.177V12.82c0-.364.114-.72.326-1.017l1.777-2.488a1.75 1.75 0 0 1 2.325-.483l1.412.847a.25.25 0 0 0 .16.034l3.254-.407a.25.25 0 0 0 .164-.092l1.527-1.909a.25.25 0 0 0 .055-.156V4.927A8.211 8.211 0 0 0 12 3.75Zm5.75 2.334v1.065c0 .398-.135.783-.384 1.093l-1.527 1.91a1.75 1.75 0 0 1-1.15.643l-3.253.406a1.75 1.75 0 0 1-1.118-.236l-1.412-.847a.25.25 0 0 0-.332.07l-1.777 2.487a.25.25 0 0 0-.047.145v2.766c0 .464-.184.909-.513 1.237l-.521.522A8.232 8.232 0 0 0 12 20.25c1.608 0 3.109-.46 4.377-1.256-.098-.099-.386-.383-.386-.383l-2.014-.525a1.5 1.5 0 0 1-1.088-1.666l.218-1.535a1.519 1.519 0 0 1 .908-1.148l2.853-1.192a1.5 1.5 0 0 1 1.593.281l1.494 1.368A8.258 8.258 0 0 0 20.25 12c0-2.32-.958-4.417-2.5-5.916Zm-.17 11.992a8.279 8.279 0 0 0 1.797-2.378l-1.93-1.767c-.413.172-2.86 1.2-2.86 1.2l-.214 1.508 2.019.526c.252.07.481.204.666.389l.523.522Z"/></svg>`
};
export const ciEventsFilled = {
    name: 'events-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7 2a1 1 0 0 1 1 1h8a1 1 0 1 1 2 0 3 3 0 0 1 3 3v1H3V6a3 3 0 0 1 3-3 1 1 0 0 1 1-1Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M21 9H3v9a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V9Zm-5.86 2.232a1 1 0 0 1 .128 1.408l-3.333 4a1 1 0 0 1-1.46.081l-1.668-1.6a1 1 0 0 1 1.386-1.442l.892.857 2.647-3.176a1 1 0 0 1 1.408-.128Z"/></svg>`
};
export const ciEventsOutlined = {
    name: 'events-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M14.416 11.376a.75.75 0 0 1 .208 1.04l-2.667 4a.75.75 0 0 1-1.2.064l-1.333-1.6a.75.75 0 1 1 1.152-.96l.69.828 2.11-3.164a.75.75 0 0 1 1.04-.208Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M17 2.25a.75.75 0 0 1 .75.75v.58A3.501 3.501 0 0 1 20.5 7v10a3.5 3.5 0 0 1-3.5 3.5H7A3.5 3.5 0 0 1 3.5 17V7a3.501 3.501 0 0 1 2.75-3.42V3a.75.75 0 0 1 1.5 0v.5h8.5V3a.75.75 0 0 1 .75-.75ZM7 5a2 2 0 0 0-2 2v1.25h14V7a2 2 0 0 0-2-2H7Zm12 4.75H5V17a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V9.75Z"/></svg>`
};
export const ciExternalLinkOutlined = {
    name: 'external-link-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M6 4.75c-.69 0-1.25.56-1.25 1.25v12c0 .69.56 1.25 1.25 1.25h12c.69 0 1.25-.56 1.25-1.25v-3a.75.75 0 0 1 1.5 0v3A2.75 2.75 0 0 1 18 20.75H6A2.75 2.75 0 0 1 3.25 18V6A2.75 2.75 0 0 1 6 3.25h3a.75.75 0 0 1 0 1.5H6Z"/><path d="M13.25 4a.75.75 0 0 1 .75-.75h5c.966 0 1.75.784 1.75 1.75v5a.75.75 0 0 1-1.5 0V5.81l-6.72 6.72a.75.75 0 1 1-1.06-1.06l6.72-6.72H14a.75.75 0 0 1-.75-.75Z"/></svg>`
};
export const ciFlashCircleOutlined = {
    name: 'flash-circle-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m12.46 6.983-3.72 4.185a.5.5 0 0 0 .373.832h1.554l-.643 4.341a.5.5 0 0 0 .868.406l4.368-4.915a.5.5 0 0 0-.373-.832h-1.554V7.315a.5.5 0 0 0-.873-.332Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM3.75 12a8.25 8.25 0 1 1 16.5 0 8.25 8.25 0 0 1-16.5 0Z"/></svg>`
};
export const ciFlashOutlined = {
    name: 'flash-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.523 2.293a.75.75 0 0 1 .5.698l.082 7.259H18a.75.75 0 0 1 .552 1.257l-9.181 10a.75.75 0 0 1-1.299-.583l.734-7.174H6a.75.75 0 0 1-.578-1.228l8.273-10a.75.75 0 0 1 .828-.23Zm-6.93 9.957h2.043a.75.75 0 0 1 .747.826l-.589 5.752 6.5-7.078h-1.93a.75.75 0 0 1-.75-.742l-.068-5.953-5.952 7.195Z"/></svg>`
};
...
export const ciFolderOutlined = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.25 6c0-.966.784-1.75 1.75-1.75h7.382a1.75 1.75 0 0 1 1.565.967l1.517 3.033H20c.966 0 1.75.784 1.75 1.75v8A1.75 1.75 0 0 1 20 19.75H4A1.75 1.75 0 0 1 2.25 18V6Zm1.5 0A.25.25 0 0 1 4 5.75h7.382a.25.25 0 0 1 .224.138l1.18 2.362H3.75V6Zm0 12V9.75H20a.25.25 0 0 1 .25.25v8a.25.25 0 0 1-.25.25H4a.25.25 0 0 1-.25-.25Z"/></svg>`
};
...
export const ciHashtagOutlined = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.733 5.157a.75.75 0 0 0-1.466-.314l-.73 3.407H6a.75.75 0 1 0 0 1.5h2.215l-.964 4.5H5a.75.75 0 0 0 0 1.5h1.93l-.663 3.093a.75.75 0 1 0 1.466.314l.73-3.407h5.466l-.662 3.093a.75.75 0 0 0 1.466.314l.73-3.407H18a.75.75 0 0 0 0-1.5h-2.215l.964-4.5H19a.75.75 0 0 0 0-1.5h-1.93l.663-3.093a.75.75 0 0 0-1.466-.314l-.73 3.407H10.07l.662-3.093ZM9.75 9.75l-.964 4.5h5.466l.964-4.5H9.75Z"/></svg>`
};
export const ciHomeFilled = {
    name: 'home-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.797 9.109a2 2 0 0 0-.677 1.74l.962 8.38A2 2 0 0 0 6.07 21h11.862a2 2 0 0 0 1.987-1.772l.962-8.38a2 2 0 0 0-.677-1.74L13.31 3.136a2 2 0 0 0-2.62 0L3.797 9.11ZM9 21v-6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v6H9Z"/></svg>`
};
export const ciHomeOutlined = {
    name: 'home-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.997 20.75h8.076a2.75 2.75 0 0 0 2.732-2.438l.821-7.205a2.75 2.75 0 0 0-.924-2.384l-5.894-5.141a2.75 2.75 0 0 0-3.616 0L4.298 8.723a2.75 2.75 0 0 0-.924 2.384l.821 7.205a2.75 2.75 0 0 0 2.733 2.438h2.069Zm2.181-16.038a1.25 1.25 0 0 1 1.644 0l5.894 5.142c.31.27.466.675.42 1.083l-.822 7.205a1.25 1.25 0 0 1-1.242 1.108H15.75V15A2.75 2.75 0 0 0 13 12.25h-2A2.75 2.75 0 0 0 8.25 15v4.25H6.928a1.25 1.25 0 0 1-1.242-1.108l-.822-7.205a1.25 1.25 0 0 1 .42-1.083l5.894-5.142ZM14.25 19.25h-4.5V15c0-.69.56-1.25 1.25-1.25h2c.69 0 1.25.56 1.25 1.25v4.25Z"/></svg>`
};
export const ciLayersFilled = {
    name: 'layers-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12.568 3.177a1 1 0 0 0-1.136 0l-7 4.833a1 1 0 0 0 0 1.646l7 4.834a1 1 0 0 0 1.136 0l7-4.834a1 1 0 0 0 0-1.646l-7-4.833Z"/><path d="M5.581 14.186a1 1 0 0 0-1.162 1.628l7 5a1 1 0 0 0 1.162 0l7-5a1 1 0 0 0-1.162-1.628L12 18.771l-6.419-4.585Z"/></svg>`
};
export const ciLayersOutlined = {
    name: 'layers-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.426 3.383a.75.75 0 0 0-.852 0l-7 4.833a.75.75 0 0 0 0 1.235l7 4.833a.75.75 0 0 0 .852 0l7-4.833a.75.75 0 0 0 0-1.235l-7-4.833ZM12 12.755 6.32 8.833 12 4.911l5.68 3.922L12 12.755Z"/><path d="M5.436 14.39a.75.75 0 1 0-.872 1.22l7 5a.75.75 0 0 0 .872 0l7-5a.75.75 0 1 0-.872-1.22L12 19.078 5.436 14.39Z"/></svg>`
};
export const ciLikesCircleFilled = {
    name: 'likes-circle-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10ZM9.957 9.859c.758-.832 1.034-1.891 1.325-3.01l.056-.213c.122-.464.61-.856 1.007-.587.39.264.806.906 1.173 2.53.107.471.518.82 1.002.82h1.8a1 1 0 0 1 .942 1.338l-1.746 4.874a1 1 0 0 1-.942.663h-3.947a1 1 0 0 1-1-1v-4.636c0-.292.133-.563.33-.78Zm-3.228 5.546v-4.058a.87.87 0 1 1 1.739 0v4.058a.87.87 0 1 1-1.739 0Z"/></svg>`
};
export const ciLinkOutlined = {
    name: 'link-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M2.25 12A4.75 4.75 0 0 1 7 7.25h2a.75.75 0 0 1 0 1.5H7a3.25 3.25 0 0 0 0 6.5h2a.75.75 0 0 1 0 1.5H7A4.75 4.75 0 0 1 2.25 12Zm12-4a.75.75 0 0 1 .75-.75h2a4.75 4.75 0 1 1 0 9.5h-2a.75.75 0 0 1 0-1.5h2a3.25 3.25 0 0 0 0-6.5h-2a.75.75 0 0 1-.75-.75Z"/><path d="M10 11.25a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5h-4Z"/></svg>`
};
export const ciLocationOutlined = {
    name: 'location-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 6.25a3.75 3.75 0 1 0 0 7.5 3.75 3.75 0 0 0 0-7.5ZM9.75 10a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="m11.554 21.603.002.002a.75.75 0 0 0 .888 0h-.84.84l.002-.002.005-.004.018-.013.064-.048a22.917 22.917 0 0 0 1.054-.867 25.71 25.71 0 0 0 2.48-2.48c1.781-2.053 3.683-4.979 3.683-8.191a7.75 7.75 0 0 0-15.5 0c0 3.212 1.902 6.138 3.684 8.191a25.715 25.715 0 0 0 3.3 3.165c.099.079.178.14.233.182l.064.048.018.013.005.004ZM5.75 10a6.25 6.25 0 1 1 12.5 0c0 2.654-1.598 5.228-3.316 7.208A24.227 24.227 0 0 1 12 20.048a24.227 24.227 0 0 1-2.934-2.84C7.348 15.228 5.75 12.654 5.75 10Z"/></svg>`
};
export const ciLockFilled = {
    name: 'lock-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.25 9.25V8a4.75 4.75 0 0 1 9.5 0v1.25H17c.966 0 1.75.784 1.75 1.75v8A1.75 1.75 0 0 1 17 20.75H7A1.75 1.75 0 0 1 5.25 19v-8c0-.966.784-1.75 1.75-1.75h.25ZM8.75 8a3.25 3.25 0 0 1 6.5 0v1.25h-6.5V8Z"/></svg>`
};
export const ciLockOpenFilled = {
    name: 'lock-open-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.75 8a3.25 3.25 0 0 1 4.874-2.816.75.75 0 1 0 .752-1.298A4.75 4.75 0 0 0 7.25 8v1.25H7A1.75 1.75 0 0 0 5.25 11v8c0 .966.784 1.75 1.75 1.75h10A1.75 1.75 0 0 0 18.75 19v-8A1.75 1.75 0 0 0 17 9.25H8.75V8Z"/></svg>`
};
export const ciLockOpenOutlined = {
    name: 'lock-open-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.75 8a3.25 3.25 0 0 1 4.874-2.816.75.75 0 1 0 .752-1.298A4.75 4.75 0 0 0 7.25 8v1.25H7A1.75 1.75 0 0 0 5.25 11v8c0 .966.784 1.75 1.75 1.75h10A1.75 1.75 0 0 0 18.75 19v-8A1.75 1.75 0 0 0 17 9.25H8.75V8ZM7 10.75a.25.25 0 0 0-.25.25v8c0 .138.112.25.25.25h10a.25.25 0 0 0 .25-.25v-8a.25.25 0 0 0-.25-.25H7Z"/></svg>`
};
export const ciLockOutlined = {
    name: 'lock-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.25 9.25V8a4.75 4.75 0 0 1 9.5 0v1.25H17c.966 0 1.75.784 1.75 1.75v8A1.75 1.75 0 0 1 17 20.75H7A1.75 1.75 0 0 1 5.25 19v-8c0-.966.784-1.75 1.75-1.75h.25ZM8.75 8a3.25 3.25 0 0 1 6.5 0v1.25h-6.5V8ZM7 10.75a.25.25 0 0 0-.25.25v8c0 .138.112.25.25.25h10a.25.25 0 0 0 .25-.25v-8a.25.25 0 0 0-.25-.25H7Z"/></svg>`
};
export const ciMarketplaceFilled = {
    name: 'marketplace-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M9.75 12A2.25 2.25 0 0 0 12 9.75a2.25 2.25 0 0 0 4.5 0 2.25 2.25 0 0 0 4.5 0V8.444a4 4 0 0 0-.422-1.789l-1.552-3.102A1 1 0 0 0 18.132 3H5.868a1 1 0 0 0-.894.553L3.422 6.655A4 4 0 0 0 3 8.445V9.75a2.25 2.25 0 0 0 4.5 0A2.25 2.25 0 0 0 9.75 12ZM5 13v3H4a1 1 0 1 0 0 2h1v2a1 1 0 1 0 2 0v-2h10v2a1 1 0 1 0 2 0v-2h1a1 1 0 1 0 0-2h-1v-3h-2v3H7v-3H5Z"/></svg>`
};
...
export const ciMegaphoneOutlined = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.26 3.984a1.75 1.75 0 0 1 2.49 1.586v9.953a1.75 1.75 0 0 1-2.4 1.625L2.866 12.554c-1.423-.569-1.479-2.562-.09-3.21l11.484-5.36Zm.99 1.586a.25.25 0 0 0-.356-.226L3.41 10.703a.25.25 0 0 0 .013.459l11.484 4.593a.25.25 0 0 0 .343-.232V5.57Z"/><path d="M6 15.25a.75.75 0 0 1 .75.75v3a.75.75 0 0 1-1.5 0v-3a.75.75 0 0 1 .75-.75Zm13-4h2a.75.75 0 0 0 0-1.5h-2a.75.75 0 0 0 0 1.5Zm1.53-6.78a.75.75 0 0 1 0 1.06l-1 1a.75.75 0 1 1-1.06-1.06l1-1a.75.75 0 0 1 1.06 0Zm0 11-1-1a.75.75 0 1 0-1.06 1.06l1 1a.75.75 0 1 0 1.06-1.06Z"/></svg>`
};
export const ciMicrosoftTeams = {
    name: 'microsoft-teams',
    data: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#a)"><path d="M15.95 9.977h5.166c.488 0 .884.395.884.883v4.706a3.248 3.248 0 0 1-3.248 3.248h-.015a3.248 3.248 0 0 1-3.249-3.248v-5.127c0-.255.207-.462.462-.462Zm3.492-.93a2.093 2.093 0 1 0 0-4.187 2.093 2.093 0 0 0 0 4.187Z" fill="#5059C9"/><path d="M12.93 9.047a3.023 3.023 0 1 0 0-6.047 3.023 3.023 0 0 0 0 6.047Zm4.031.93H8.434a.874.874 0 0 0-.853.894v5.367a5.246 5.246 0 0 0 5.117 5.367 5.246 5.246 0 0 0 5.116-5.367v-5.367a.875.875 0 0 0-.853-.894Z" fill="#7B83EB"/><path opacity=".1" d="M13.163 9.977v7.52a.856.856 0 0 1-.851.852H7.99a5.664 5.664 0 0 1-.41-2.112V10.87a.873.873 0 0 1 .852-.893h4.73Z"/><path opacity=".2" d="M12.698 9.977v7.986a.857.857 0 0 1-.851.851H8.209a6.021 6.021 0 0 1-.218-.465 5.664 5.664 0 0 1-.41-2.112V10.87a.873.873 0 0 1 .852-.893h4.265Z"/><path opacity=".2" d="M12.698 9.977v7.056a.858.858 0 0 1-.851.85h-4.02a5.665 5.665 0 0 1-.246-1.646V10.87a.873.873 0 0 1 .852-.893h4.265Z"/><path opacity=".2" d="M12.233 9.977v7.056a.858.858 0 0 1-.852.85H7.828a5.664 5.664 0 0 1-.247-1.646V10.87a.873.873 0 0 1 .852-.893h3.8Z"/><path opacity=".1" d="M13.163 7.572v1.465c-.08.005-.154.01-.233.01-.079 0-.153-.005-.232-.01a2.552 2.552 0 0 1-.465-.074 3.023 3.023 0 0 1-2.094-1.777 2.582 2.582 0 0 1-.148-.465h2.32c.47.002.85.382.852.851Z"/><path opacity=".2" d="M12.698 8.037v1a2.553 2.553 0 0 1-.465-.074 3.024 3.024 0 0 1-2.094-1.777h1.708a.853.853 0 0 1 .85.851Z"/><path opacity=".2" d="M12.698 8.037v1a2.553 2.553 0 0 1-.465-.074 3.024 3.024 0 0 1-2.094-1.777h1.708a.853.853 0 0 1 .85.851Z"/><path opacity=".2" d="M12.233 8.037v.926a3.023 3.023 0 0 1-2.094-1.777h1.242c.47.002.85.382.852.851Z"/><path d="M2.853 7.186h8.527c.47 0 .852.382.852.853v8.527c0 .47-.381.853-.852.853H2.853A.853.853 0 0 1 2 16.566V8.039c0-.471.382-.853.853-.853Z" fill="url(#b)"/><path d="M9.36 10.432H7.655v4.641H6.57v-4.641H4.873v-.9H9.36v.9Z" fill="#fff"/></g><defs><linearGradient id="b" x1="3.778" y1="6.52" x2="10.455" y2="18.085" gradientUnits="userSpaceOnUse"><stop stop-color="#5A62C3"/><stop offset=".5" stop-color="#4D55BD"/><stop offset="1" stop-color="#3940AB"/></linearGradient><clipPath id="a"><path fill="#fff" transform="translate(2 3)" d="M0 0h20v18.605H0z"/></clipPath></defs></svg>`
};
export const ciMicrosoftYammer = {
    name: 'microsoft-yammer',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M19.5 12.323c0 3.819-1.728 7.26-4.492 9.677l-9.883-9.677H19.5Z" fill="url(#a)"/><path d="M19.5 12.323H5.125L15.008 2A14.073 14.073 0 0 1 19.5 12.323Z" fill="url(#b)"/><path d="M21.27 16.839c.474-1.52.73-3.148.73-4.839 0-1.691-.256-3.318-.73-4.839L5.126 12.323l16.146 4.516Z" fill="url(#c)"/><path d="M6.375 10.161a3 3 0 0 1 3-3H11.5a3 3 0 0 1 3 3V16.8a1.976 1.976 0 0 1-3.395 1.374l-.668-.69H9.376a3 3 0 0 1-3-3v-4.322Z" fill-opacity=".3"/><rect x="2" y="5.871" width="11.25" height="11.613" rx="2" fill="url(#d)"/><path d="M7.485 11.027 6.012 8.452H4.5l2.398 4.156v2.295h1.444v-2.295l2.408-4.156H9.228l-1.473 2.575h-.27Z" fill="#fff"/><defs><linearGradient id="a" x1="11.189" y1="15.466" x2="17.494" y2="19.183" gradientUnits="userSpaceOnUse"><stop stop-color="#0E51A3"/><stop offset="1" stop-color="#1464B6"/></linearGradient><linearGradient id="b" x1="10.066" y1="9.847" x2="17.696" y2="5.575" gradientUnits="userSpaceOnUse"><stop stop-color="#2292E2"/><stop offset="1" stop-color="#2294DB"/></linearGradient><linearGradient id="c" x1="9.85" y1="12.231" x2="21.775" y2="12.231" gradientUnits="userSpaceOnUse"><stop stop-color="#176FE0"/><stop offset="1" stop-color="#2F9FEF"/></linearGradient><linearGradient id="d" x1="2" y1="11.677" x2="13.25" y2="11.677" gradientUnits="userSpaceOnUse"><stop stop-color="#084C8A"/><stop offset="1" stop-color="#1572CB"/></linearGradient></defs></svg>`
};
export const ciPaperclipBoxOutlined = {
    name: 'paperclip-box-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7 3.25A3.75 3.75 0 0 0 3.25 7v10A3.75 3.75 0 0 0 7 20.75h2a.75.75 0 0 0 0-1.5H7A2.25 2.25 0 0 1 4.75 17V7A2.25 2.25 0 0 1 7 4.75h10A2.25 2.25 0 0 1 19.25 7v1a.75.75 0 0 0 1.5 0V7A3.75 3.75 0 0 0 17 3.25H7Z"/><path d="M13.946 7.25a3.696 3.696 0 0 0-3.696 3.696V15.5a5.25 5.25 0 1 0 10.5 0v-3.167a.75.75 0 0 0-1.5 0V15.5a3.75 3.75 0 1 1-7.5 0v-4.554a2.196 2.196 0 0 1 4.393 0v4.94a.696.696 0 0 1-1.393 0v-4.553a.75.75 0 0 0-1.5 0v4.554a2.196 2.196 0 1 0 4.393 0v-4.94a3.696 3.696 0 0 0-3.697-3.697Z"/></svg>`
};
export const ciPaperclipOutlined = {
    name: 'paperclip-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.46 4.495a4.679 4.679 0 0 1 6.616 6.616l-5.208 5.208A2.678 2.678 0 1 1 8.08 12.53l4.647-4.647a.75.75 0 1 1 1.06 1.06L9.141 13.59a1.179 1.179 0 0 0 1.666 1.667l5.208-5.208a3.179 3.179 0 0 0-4.495-4.495l-5 5a5.25 5.25 0 0 0 7.425 7.425l4.439-4.439a.75.75 0 0 1 1.06 1.06l-4.439 4.44A6.75 6.75 0 1 1 5.46 9.495l5-5Z"/></svg>`
};
...
export const ciPhotoFilled = {
    name: 'photo-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M15.5 10a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3.25 7A3.75 3.75 0 0 1 7 3.25h10A3.75 3.75 0 0 1 20.75 7v10A3.75 3.75 0 0 1 17 20.75H7A3.75 3.75 0 0 1 3.25 17V7ZM7 4.75A2.25 2.25 0 0 0 4.75 7v3.742c4.222-1.342 5.746.124 7.3 1.618 1.52 1.462 3.067 2.951 7.2 1.858V7A2.25 2.25 0 0 0 17 4.75H7Z"/></svg>`
};
export const ciPhotoOutlined = {
    name: 'photo-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M15.5 10a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3.25 7A3.75 3.75 0 0 1 7 3.25h10A3.75 3.75 0 0 1 20.75 7v10A3.75 3.75 0 0 1 17 20.75H7A3.75 3.75 0 0 1 3.25 17V7ZM7 4.75A2.25 2.25 0 0 0 4.75 7v3.957c1.947-.587 3.42-.617 4.632-.263 1.402.41 2.334 1.305 3.138 2.078l.003.003c.829.796 1.528 1.469 2.55 1.82.922.318 2.2.398 4.177-.154V7A2.25 2.25 0 0 0 17 4.75H7ZM4.75 17v-4.469c2.006-.672 3.292-.666 4.212-.397 1.004.293 1.697.93 2.518 1.72l.08.075c.777.75 1.686 1.624 3.024 2.085 1.212.417 2.694.473 4.666-.021V17A2.25 2.25 0 0 1 17 19.25H7A2.25 2.25 0 0 1 4.75 17Z"/></svg>`
};
...
export const ciPlusCircleFilled = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Zm0-14a1 1 0 0 1 1 1v2h2a1 1 0 1 1 0 2h-2v2a1 1 0 1 1-2 0v-2H9a1 1 0 1 1 0-2h2V9a1 1 0 0 1 1-1Z"/></svg>`
};
export const ciPlusCircleOutlined = {
    name: 'plus-circle-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 8.25a.75.75 0 0 1 .75.75v2.25H15a.75.75 0 0 1 0 1.5h-2.25V15a.75.75 0 0 1-1.5 0v-2.25H9a.75.75 0 0 1 0-1.5h2.25V9a.75.75 0 0 1 .75-.75Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM3.75 12a8.25 8.25 0 1 1 16.5 0 8.25 8.25 0 0 1-16.5 0Z"/></svg>`
};
...
export const ciPlusSquareFilled = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5 3a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5Zm7 5a1 1 0 0 1 1 1v2h2a1 1 0 1 1 0 2h-2v2a1 1 0 1 1-2 0v-2H9a1 1 0 1 1 0-2h2V9a1 1 0 0 1 1-1Z"/></svg>`
};
export const ciPlusSquareOutlined = {
    name: 'plus-square-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 8.25a.75.75 0 0 1 .75.75v2.25H15a.75.75 0 0 1 0 1.5h-2.25V15a.75.75 0 0 1-1.5 0v-2.25H9a.75.75 0 0 1 0-1.5h2.25V9a.75.75 0 0 1 .75-.75Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3.25 5c0-.966.784-1.75 1.75-1.75h14c.966 0 1.75.784 1.75 1.75v14A1.75 1.75 0 0 1 19 20.75H5A1.75 1.75 0 0 1 3.25 19V5ZM5 4.75a.25.25 0 0 0-.25.25v14c0 .138.112.25.25.25h14a.25.25 0 0 0 .25-.25V5a.25.25 0 0 0-.25-.25H5Z"/></svg>`
};
export const ciPrinterFilled = {
    name: 'printer-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.272 3.818A.75.75 0 0 1 7 3.25h10a.75.75 0 0 1 .728.568l.858 3.432c1.22 0 2.164 1.05 2.164 2.25V16A1.75 1.75 0 0 1 19 17.75h-1.25V20a.75.75 0 0 1-.75.75H7a.75.75 0 0 1-.75-.75v-2.25H5A1.75 1.75 0 0 1 3.25 16V9.5c0-1.2.944-2.25 2.164-2.25l.858-3.432Zm.689 3.432h10.078l-.625-2.5H7.586l-.625 2.5Zm.789 12h8.5v-4.5h-8.5v4.5Z"/></svg>`
};
...
export const ciUploadOutlined = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7.47 9.53a.75.75 0 0 0 1.06 0l2.72-2.72V15a.75.75 0 0 0 1.5 0V6.81l2.72 2.72a.75.75 0 1 0 1.06-1.06l-4-4a.75.75 0 0 0-1.06 0l-4 4a.75.75 0 0 0 0 1.06Z"/><path d="M4.75 14a.75.75 0 0 0-1.5 0v5.25c0 .39.15.77.425 1.052.275.284.653.448 1.052.448h14.546c.4 0 .777-.164 1.052-.448.275-.282.425-.662.425-1.052V14a.75.75 0 0 0-1.5 0v5.25H4.75V14Z"/></svg>`
};
export const ciVideoCameraFilled = {
    name: 'video-camera-filled',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M2 17.714V6.286C2 5.023 2.995 4 4.222 4h10c1.228 0 2.222 1.023 2.222 2.286v3.428l4.03-2.487A1 1 0 0 1 22 8.078v7.844a1 1 0 0 1-1.525.851l-4.03-2.487v3.428c0 1.263-.995 2.286-2.223 2.286h-10C2.995 20 2 18.977 2 17.714Z"/></svg>`
};
...
export const ci16EditorArrowUp = {
    ...
    data: `<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M8.53 1.47a.75.75 0 0 0-1.06 0l-5 5a.75.75 0 0 0 1.06 1.06l3.72-3.72V14a.75.75 0 0 0 1.5 0V3.81l3.72 3.72a.75.75 0 1 0 1.06-1.06l-5-5Z"/></svg>`
};
export const ci16EditorBold = {
    name: '16-editor-bold',
    data: `<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.25 2A.75.75 0 0 1 4 1.25h4a3.75 3.75 0 0 1 2.665 6.389A3.75 3.75 0 0 1 9 14.75H4a.75.75 0 0 1-.75-.75V2Zm1.5.75v4.5H8a2.25 2.25 0 0 0 0-4.5H4.75Zm0 6v4.5H9a2.25 2.25 0 0 0 0-4.5H4.75Z"/></svg>`
};
...
export const ciCircleOutlinedS = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 8.75a3.25 3.25 0 1 0 0 6.5 3.25 3.25 0 0 0 0-6.5ZM7.25 12a4.75 4.75 0 1 1 9.5 0 4.75 4.75 0 0 1-9.5 0Z"/></svg>`
};
...
export const ciFlagCircleJp = {
    name: 'flag-circle-jp',
    data: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" style="fill:none"><rect width="21" height="21" x="1.5" y="1.5" fill="#fff" rx="10.5"/><path fill="#F93939" d="M12 16.667a4.667 4.667 0 1 0 0-9.334 4.667 4.667 0 0 0 0 9.334Z"/><rect width="21" height="21" x="1.5" y="1.5" stroke="#EBECF0" rx="10.5"/></svg>`
};
export const ciFlagCircleKr = {
    name: 'flag-circle-kr',
    data: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" style="fill:none"><rect width="21" height="21" x="1.5" y="1.5" fill="#fff" rx="10.5"/><path fill="#232C80" fill-rule="evenodd" d="M16.667 12a4.667 4.667 0 1 1-9.334 0c0-1.493 3.134-2.12 5.771-1.884.28-.075.581-.116.896-.116 1.473 0 2.667.896 2.667 2Z" clip-rule="evenodd"/><path fill="#F93939" fill-rule="evenodd" d="M11.333 11.333S12.527 10 14 10c1.473 0 2.667.896 2.667 2a4.667 4.667 0 0 0-8.886-1.997c-.448 1.33-.448 1.72-.448 1.997.667.667 1.408.667 2 .667.592 0 1.124-.258 1.491-.667l.51-.667Z" clip-rule="evenodd"/><path fill="#151515" fill-rule="evenodd" d="M18 8.667h2.667L18 6h-1.333L18 8.667Zm-12 0H3.333L6 6h1.333L6 8.667Zm12 6.666h2.667L18 18h-1.333L18 15.333Zm-12 0H3.333L6 18h1.333L6 15.333Z" clip-rule="evenodd"/><rect width="21" height="21" x="1.5" y="1.5" stroke="#EBECF0" rx="10.5"/></svg>`
};
...
export const ciFlagJp = {
    name: 'flag-jp',
    data: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" style="fill:none"><rect width="20" height="14" x="2" y="5" fill="#fff" rx="3"/><path fill="#F93939" d="M12 15.267c1.84 0 3.333-1.463 3.333-3.267 0-1.804-1.492-3.267-3.333-3.267-1.841 0-3.333 1.463-3.333 3.267 0 1.804 1.492 3.267 3.333 3.267Z"/><rect width="21" height="15" x="1.5" y="4.5" stroke="#000" stroke-opacity=".07" rx="3.5"/></svg>`
};
export const ciFlagKr = {
    name: 'flag-kr',
    data: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" style="fill:none"><rect width="20" height="14" x="2" y="5" fill="#fff" rx="3"/><path fill="#232C80" fill-rule="evenodd" d="M15.333 12c0 1.804-1.492 3.267-3.333 3.267-1.841 0-3.333-1.463-3.333-3.267 0-1.045 2.238-1.484 4.122-1.319.2-.052.415-.081.64-.081 1.052 0 1.904.627 1.904 1.4Z" clip-rule="evenodd"/><path fill="#F93939" fill-rule="evenodd" d="M11.524 11.533s.852-.933 1.905-.933c1.052 0 1.904.627 1.904 1.4 0-1.804-1.492-3.267-3.333-3.267-1.33 0-2.48.764-3.013 1.869-.32.931-.32 1.204-.32 1.398.476.467 1.005.467 1.428.467.423 0 .803-.18 1.065-.467l.364-.467Z" clip-rule="evenodd"/><path fill="#151515" fill-rule="evenodd" d="M16.286 9.667h1.904L16.287 7.8h-.953l.953 1.867Zm-8.572 0H5.81L7.714 7.8h.953l-.953 1.867Zm8.572 4.666h1.904L16.287 16.2h-.953l.953-1.867Zm-8.572 0H5.81L7.714 16.2h.953l-.953-1.867Z" clip-rule="evenodd"/><rect width="21" height="15" x="1.5" y="4.5" stroke="#000" stroke-opacity=".07" rx="3.5"/></svg>`
};
...
export const ciHaiiloHome = {
    name: 'haiilo-home',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.001 14.024a2.024 2.024 0 1 0 0-4.048 2.024 2.024 0 0 0 0 4.048Zm6.974 0a2.025 2.025 0 1 0 0-4.049 2.025 2.025 0 0 0 0 4.05ZM12.001 21a2.025 2.025 0 1 0 0-4.05 2.025 2.025 0 0 0 0 4.05Zm-6.976-6.976a2.024 2.024 0 1 0 0-4.049 2.024 2.024 0 0 0 0 4.05ZM12 7.05a2.024 2.024 0 1 0 0-4.049 2.024 2.024 0 0 0 0 4.049ZM5.026 21a2.025 2.025 0 1 0 0-4.05 2.025 2.025 0 0 0 0 4.05Zm13.948 0a2.025 2.025 0 1 0 0-4.05 2.025 2.025 0 0 0 0 4.05Z" fill="#1B6C75"/></svg>`
};
...
export const ciWButtonOutlined = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7 12.75h10v-1.5H7v1.5Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M6 4.25A3.75 3.75 0 0 0 2.25 8v8A3.75 3.75 0 0 0 6 19.75h12A3.75 3.75 0 0 0 21.75 16V8A3.75 3.75 0 0 0 18 4.25H6ZM3.75 8A2.25 2.25 0 0 1 6 5.75h12A2.25 2.25 0 0 1 20.25 8v8A2.25 2.25 0 0 1 18 18.25H6A2.25 2.25 0 0 1 3.75 16V8Z"/></svg>`
};
export const ciWColleaguesNewOutlined = {
    name: 'w-colleagues-new-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11.86 12.793a4.75 4.75 0 1 0-5.72 0c-2.256.899-3.89 2.834-3.89 5.207a.75.75 0 0 0 1.5 0c0-2.225 2.217-4.25 5.25-4.25s5.25 2.025 5.25 4.25a.75.75 0 0 0 1.5 0c0-2.373-1.634-4.309-3.89-5.207ZM5.75 9a3.25 3.25 0 1 1 6.5 0 3.25 3.25 0 0 1-6.5 0Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M14.25 10.5a3.25 3.25 0 1 1 5.517 2.33c1.168.646 1.983 1.787 1.983 3.17a.75.75 0 0 1-1.5 0c0-1.138-1.119-2.25-2.75-2.25-.636 0-1.212.177-1.67.465a.75.75 0 1 1-.799-1.27c.066-.04.132-.08.2-.118a3.24 3.24 0 0 1-.981-2.327Zm3.25-1.75a1.75 1.75 0 1 0 0 3.5 1.75 1.75 0 0 0 0-3.5Z"/></svg>`
};
export const ciWCompleteProfileOutlined = {
    name: 'w-complete-profile-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M21.6 4.45a.75.75 0 1 0-1.2-.9l-2.536 3.381-1.396-1.117a.75.75 0 1 0-.937 1.172l2 1.6A.75.75 0 0 0 18.6 8.45l3-4ZM2.25 7A.75.75 0 0 1 3 6.25h9a.75.75 0 0 1 0 1.5H3A.75.75 0 0 1 2.25 7Zm19.35 3.45a.75.75 0 1 0-1.2-.9l-2.536 3.381-1.396-1.117a.75.75 0 1 0-.937 1.172l2 1.6a.75.75 0 0 0 1.069-.136l3-4ZM2.25 12a.75.75 0 0 1 .75-.75h9a.75.75 0 0 1 0 1.5H3a.75.75 0 0 1-.75-.75Zm0 5a.75.75 0 0 1 .75-.75h9a.75.75 0 0 1 0 1.5H3a.75.75 0 0 1-.75-.75Z"/></svg>`
};
export const ciWDividerOutlined = {
    name: 'w-divider-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.25 12a.75.75 0 0 1 .75-.75h18a.75.75 0 0 1 0 1.5H3a.75.75 0 0 1-.75-.75Z"/></svg>`
};
export const ciWDoYouKnowOutlined = {
    name: 'w-do-you-know-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7 3.75A3.25 3.25 0 0 0 3.75 7v10c0 .642.186 1.241.508 1.745.112-1.826 1.423-3.278 3.188-4a3.75 3.75 0 1 1 5.108 0C14.4 15.5 15.75 17.056 15.75 19v1.25H17A3.25 3.25 0 0 0 20.25 17v-1a.75.75 0 0 1 1.5 0v1A4.75 4.75 0 0 1 17 21.75H7A4.75 4.75 0 0 1 2.25 17V7A4.75 4.75 0 0 1 7 2.25h5a.75.75 0 0 1 0 1.5H7ZM5.75 19c0-1.647 1.738-3.25 4.25-3.25s4.25 1.603 4.25 3.25v1.25H7A3.24 3.24 0 0 1 5.75 20v-1Zm6.5-7a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z"/><path d="M19 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm-1.81-7.231c.302-.714.691-1.112 1.055-1.316a1.547 1.547 0 0 1 1.118-.163 1.795 1.795 0 0 1 1.387 1.745c0 .403-.183.75-.544 1.071-.371.332-.894.597-1.45.787l-.506.174V10h1.5v-.882c.509-.217 1.024-.508 1.455-.892.586-.522 1.045-1.25 1.045-2.19a3.295 3.295 0 0 0-2.554-3.208 3.047 3.047 0 0 0-2.186.317c-.706.397-1.296 1.08-1.701 2.04l1.382.584Z"/></svg>`
};
export const ciWDocumentOutlined = {
    name: 'w-document-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M19.75 9c0-.675-.248-1.366-.594-1.99a8.278 8.278 0 0 0-1.376-1.79 8.28 8.28 0 0 0-1.79-1.376c-.624-.346-1.315-.594-1.99-.594H6A2.75 2.75 0 0 0 3.25 6v12A2.75 2.75 0 0 0 6 20.75h11A2.75 2.75 0 0 0 19.75 18V9Zm-15-3c0-.69.56-1.25 1.25-1.25h7.25V9c0 .414.336.75.75.75h4.25V18c0 .69-.56 1.25-1.25 1.25H6c-.69 0-1.25-.56-1.25-1.25V6Zm13.336 2.25H14.75V4.914c.16.062.331.142.51.242.493.273 1 .666 1.46 1.124a6.79 6.79 0 0 1 1.124 1.46c.1.179.18.35.242.51Z"/></svg>`
};
export const ciWDocumentsM365Outlined = {
    name: 'w-documents-m-365-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M19 17h-3a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1Z" fill="#FFB900"/><path d="M13 17h-3a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1Z" fill="#01A4EF"/><path d="M19 11h-3a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1Z" fill="#7FBA00"/><path d="M13 11h-3a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1Z" fill="#F25022"/><path fill-rule="evenodd" clip-rule="evenodd" d="M4.75 6c0-.69.56-1.25 1.25-1.25h7.25V9c0 .414.336.75.75.75h5a.75.75 0 0 0 .75-.75c0-.675-.248-1.366-.594-1.99a8.278 8.278 0 0 0-1.376-1.79 8.28 8.28 0 0 0-1.79-1.376c-.624-.346-1.315-.594-1.99-.594H6A2.75 2.75 0 0 0 3.25 6v12A2.75 2.75 0 0 0 6 20.75h1a.75.75 0 0 0 0-1.5H6c-.69 0-1.25-.56-1.25-1.25V6Zm13.336 2.25a4.116 4.116 0 0 0-.242-.51 6.79 6.79 0 0 0-1.124-1.46 6.789 6.789 0 0 0-1.46-1.124c-.179-.1-.35-.18-.51-.242V8.25h3.336Z"/></svg>`
};
export const ciWDocumentsNewOutlined = {
    name: 'w-documents-new-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6 4.75c-.69 0-1.25.56-1.25 1.25v12c0 .69.56 1.25 1.25 1.25h2a.75.75 0 0 1 0 1.5H6A2.75 2.75 0 0 1 3.25 18V6A2.75 2.75 0 0 1 6 3.25h8c.675 0 1.366.248 1.99.594a8.28 8.28 0 0 1 1.79 1.376 8.278 8.278 0 0 1 1.376 1.79c.346.624.594 1.315.594 1.99a.75.75 0 0 1-.75.75h-5a.75.75 0 0 1-.75-.75V4.75H6Zm8.75.164V8.25h3.336a4.116 4.116 0 0 0-.242-.51 6.79 6.79 0 0 0-1.124-1.46 6.789 6.789 0 0 0-1.46-1.124c-.179-.1-.35-.18-.51-.242Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M15 11.25a.75.75 0 0 1 .676.424l1.187 2.463 2.463 1.187a.75.75 0 0 1 0 1.352l-2.463 1.187-1.187 2.463a.75.75 0 0 1-1.352 0l-1.187-2.463-2.463-1.187a.75.75 0 0 1 0-1.352l2.463-1.187 1.187-2.463A.75.75 0 0 1 15 11.25Zm0 2.477-.626 1.298a.75.75 0 0 1-.35.35L12.728 16l1.298.625a.75.75 0 0 1 .35.35L15 18.273l.626-1.298a.75.75 0 0 1 .35-.35L17.272 16l-1.298-.626a.75.75 0 0 1-.35-.35L15 13.728Z"/></svg>`
};
export const ciWDownloadOutlined = {
    name: 'w-download-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12.75 4a.75.75 0 0 0-1.5 0v9.19l-2.72-2.72a.75.75 0 0 0-1.06 1.06l4 4a.75.75 0 0 0 1.06 0l4-4a.75.75 0 1 0-1.06-1.06l-2.72 2.72V4Z"/><path d="M4 13.25a.75.75 0 0 1 .75.75v5.25h14.5V14a.75.75 0 0 1 1.5 0v5.25c0 .39-.15.77-.425 1.052a1.466 1.466 0 0 1-1.052.448H4.727c-.4 0-.777-.164-1.052-.448a1.512 1.512 0 0 1-.425-1.052V14a.75.75 0 0 1 .75-.75Z"/></svg>`
};
export const ciWEventsUpcomingOutlined = {
    name: 'w-events-upcoming-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M17 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm-5 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm-3-1a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M17 2.25a.75.75 0 0 1 .75.75v.58A3.501 3.501 0 0 1 20.5 7v10a3.5 3.5 0 0 1-3.5 3.5H7A3.5 3.5 0 0 1 3.5 17V7a3.501 3.501 0 0 1 2.75-3.42V3a.75.75 0 0 1 1.5 0v.5h8.5V3a.75.75 0 0 1 .75-.75ZM7 5a2 2 0 0 0-2 2v1.25h14V7a2 2 0 0 0-2-2H7Zm12 4.75H5V17a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V9.75Z"/></svg>`
};
export const ciWFacegameOutlined = {
    name: 'w-facegame-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7.692 13.424a.75.75 0 1 0-1.136.98C7.8 15.847 9.793 16.75 12 16.75s4.2-.903 5.444-2.346a.75.75 0 1 0-1.136-.98C15.374 14.508 13.81 15.25 12 15.25c-1.81 0-3.374-.742-4.308-1.826ZM18 10a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM7 11a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM3.75 12a8.25 8.25 0 1 1 16.5 0 8.25 8.25 0 0 1-16.5 0Z"/></svg>`
};
export const ciWFeedOutlined = {
    name: 'w-feed-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4 3.25a.75.75 0 0 0-.75.75v6c0 .414.336.75.75.75h7a.75.75 0 0 0 .75-.75V4a.75.75 0 0 0-.75-.75H4Zm.75 6v-4.5h5.5v4.5h-5.5Z"/><path d="M14.25 5a.75.75 0 0 1 .75-.75h4a.75.75 0 0 1 0 1.5h-4a.75.75 0 0 1-.75-.75ZM15 8.25a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5h-4Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3.25 14a.75.75 0 0 1 .75-.75h7a.75.75 0 0 1 .75.75v6a.75.75 0 0 1-.75.75H4a.75.75 0 0 1-.75-.75v-6Zm1.5.75v4.5h5.5v-4.5h-5.5Z"/><path d="M15 14.25a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5h-4Zm0 4a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5h-4Z"/></svg>`
};
export const ciWGalleryOutlined = {
    name: 'w-gallery-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M10.757 6.454a.5.5 0 0 0-.757.43v4.233a.5.5 0 0 0 .757.429l3.528-2.117a.5.5 0 0 0 0-.858l-3.528-2.117Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M2.25 5c0-.966.784-1.75 1.75-1.75h16c.966 0 1.75.784 1.75 1.75v14A1.75 1.75 0 0 1 20 20.75H4A1.75 1.75 0 0 1 2.25 19V5Zm18 0v8.25H3.75V5A.25.25 0 0 1 4 4.75h16a.25.25 0 0 1 .25.25Zm0 9.75h-4.5v4.5H20a.25.25 0 0 0 .25-.25v-4.25Zm-10.5 0h4.5v4.5h-4.5v-4.5Zm-6 0h4.5v4.5H4a.25.25 0 0 1-.25-.25v-4.25Z"/></svg>`
};
...
export const ciWTeaserOutlined = {
    ...
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 3.25A2.75 2.75 0 0 0 5.25 6v12A2.75 2.75 0 0 0 8 20.75h8A2.75 2.75 0 0 0 18.75 18V6A2.75 2.75 0 0 0 16 3.25H8ZM6.75 6c0-.69.56-1.25 1.25-1.25h8c.69 0 1.25.56 1.25 1.25v12c0 .69-.56 1.25-1.25 1.25H8c-.69 0-1.25-.56-1.25-1.25V6Z"/><path d="M3 7.25a.75.75 0 0 1 .75.75v8a.75.75 0 0 1-1.5 0V8A.75.75 0 0 1 3 7.25Zm18 0a.75.75 0 0 1 .75.75v8a.75.75 0 0 1-1.5 0V8a.75.75 0 0 1 .75-.75Z"/></svg>`
};
export const ciWTextOutlined = {
    name: 'w-text-outlined',
    data: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7 5.25a.75.75 0 0 0 0 1.5h4.25V18a.75.75 0 0 0 1.5 0V6.75H17a.75.75 0 0 0 0-1.5H7Z"/></svg>`
};
