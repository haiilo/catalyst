...
export const ciAnchorOutlined: {
  name: 'anchor-outlined';
  data: string;
} = {
  name: 'anchor-outlined',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M13 5.75a1 1 0 1 0-2 0 1 1 0 0 0 2 0m1.5 0a2.5 2.5 0 0 1-1.75 2.385V9.25H16a.75.75 0 0 1 0 1.5h-3.25v7.36c2.162-.468 3.99-1.64 4.536-3.34a.75.75 0 1 1 1.428.46c-.884 2.75-3.886 4.167-6.62 4.514a.8.8 0 0 1-.189 0c-2.732-.347-5.735-1.765-6.619-4.514a.75.75 0 1 1 1.428-.46c.546 1.7 2.375 2.872 4.536 3.34v-7.36H8a.75.75 0 0 1 0-1.5h3.25V8.135A2.5 2.5 0 1 1 14.5 5.75"/></svg>`,
};
...
export const ciBambooHr: {
  ...
  name: 'bamboo-hr',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><g fill="#74C61E" clip-path="url(#bamboo-hr_svg__a)"><path d="M11.595 1.962h.774c.1.033.2.038.305.04.595.01 1.148.106 1.723.249a10.02 10.02 0 0 1 6.36 4.853 10.1 10.1 0 0 1 .828 7.807c-1.038 3.519-4.048 6.207-7.637 6.923-.238.048-.9.096-1.073.179h-1.657c-.386-.074-.783-.108-1.172-.186a10.2 10.2 0 0 1-3.52-1.42c-2.535-1.653-4.242-4.408-4.517-7.428-.009-.094-.01-.187-.03-.28l-.004-.015v-1.397c.027-.085.037-.301.048-.4q.035-.32.08-.637c.082-.544.367-1.499.573-2.003a9.97 9.97 0 0 1 6.739-5.952 9 9 0 0 1 1.382-.263c.16-.017.696-.021.798-.07m-.224 9.322q-.008-1.111-.005-2.223c0-.6-.008-1.223.008-1.823-.193.012-.833.025-1.02.007.039 1.53-.02 3.076.008 4.606.015.89-.076 1.912.117 2.775.331 1.485 1.817 2.446 3.29 2.401a3.5 3.5 0 0 0 2.421-1.088c.144-.154.242-.285.365-.455 1.771-2.964-1.106-6.25-4.271-4.917-.362.153-.66.417-.913.717m-2.05-.535c-.376-.372-.85-.907-1.26-1.242-.687-.561-1.781-.996-2.636-1.24-.202-.057-.448-.065-.656-.108.266.198.526.448.774.67 1.186 1.062 1.52 2.18 3.241 2.536.357.074.714.122 1.065.186-.455-1.428-.734-3.13-2.137-3.95-.12-.07-.38-.285-.5-.3l.012.016c.122.167.297.323.425.493.557.74 1.029 1.535 1.414 2.376.068.148.213.425.258.563"/><path d="M13.446 11.232a2.444 2.444 0 1 1 .491 4.863 2.444 2.444 0 0 1-.491-4.863"/></g><defs><clipPath id="bamboo-hr_svg__a"><path fill="#fff" d="M1.975 1.962h20.05v20.05H1.975z"/></clipPath></defs></svg>`,
};
...
export const ciPaylocity: {
  ...
  name: 'paylocity',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><g clip-path="url(#paylocity_svg__a)"><path fill="#F33F23" d="M2.037 12.885c.275-.016.638-.006.92-.006h1.62c1.185 0 2.726-.024 3.943.024.037.001.101.173.114.22.312 1.146.661 2.276 1.103 3.38.421.968 1.53 3.475 2.912 2.392 1.213-.952 1.77-2.831 2.253-4.245.049-.143.071-.425.253-.439l.032.032c.094.273-.308 1.984-.403 2.33-.646 2.462-2.02 5.23-4.912 5.36-4.402.196-6.89-4.51-7.76-8.196-.043-.18-.21-.71-.075-.852"/><path fill="#FD781F" d="M9.157 2.052c.576-.055 1.485.029 1.998.305-.14.232-.378.421-.553.628-1.809 2.142-2.466 5.362-2.68 8.087-.383.02-.935 0-1.332 0l-2.645-.002-1.102.003c-.206 0-.624.017-.809-.03-.137-.114.07-.773.111-.947.427-1.781 1.15-3.517 2.213-5.017 1.034-1.457 2.538-2.753 4.369-2.994.144-.019.278-.01.43-.033"/><path fill="#F33F23" d="M14.114 2.006h.628c.102.064.492.054.67.09a5.9 5.9 0 0 1 2.468 1.152c1.938 1.543 3.094 3.883 3.774 6.221.122.42.228.892.317 1.322.018.084.013.184-.041.255-.146.067-3.812.034-4.231.033l-1.417.001c-.263 0-.646.01-.899-.02-.122-.367-.204-.752-.313-1.124-.323-1.102-.684-2.226-1.201-3.255-.332-.662-.84-1.6-1.591-1.845-.3-.098-.564-.03-.835.11-1.17.602-2.057 3.325-2.445 4.532-.033.105-.053.208-.156.26-.063-.006-.048.005-.081-.032-.047-.159.058-.685.091-.87.48-2.62 1.602-6.188 4.625-6.749.197-.036.447.005.637-.08Z"/><path fill="#FD791F" d="M22.01 12.985c-.057.095-.056.216-.078.325-.766 3.903-3.619 9.32-8.38 8.53-.172-.03-.604-.108-.699-.246a.17.17 0 0 1 .046-.158c2.104-2.024 2.704-5.087 3.086-7.864.022-.16.012-.52.066-.653.095-.066 1.05-.04 1.218-.04l2.125.002 1.548-.002c.303-.002.61-.008.913.002.083.003.1.025.155.087z"/></g><defs><clipPath id="paylocity_svg__a"><path fill="#fff" d="M1.944 2.006H22.01v19.987H1.944z"/></clipPath></defs></svg>`,
};
...
export const ciRteCode: {
  ...
  name: 'rte-code',
  data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19.25 7A2.25 2.25 0 0 0 17 4.75H7A2.25 2.25 0 0 0 4.75 7v10A2.25 2.25 0 0 0 7 19.25h10A2.25 2.25 0 0 0 19.25 17zm1.5 10A3.75 3.75 0 0 1 17 20.75H7A3.75 3.75 0 0 1 3.25 17V7A3.75 3.75 0 0 1 7 3.25h10A3.75 3.75 0 0 1 20.75 7z"/><path d="M9.844 15.11a.75.75 0 0 0 .872-1.22l-2.362-1.687a.25.25 0 0 1 0-.406l2.362-1.687a.75.75 0 0 0-.872-1.22l-2.362 1.686a1.75 1.75 0 0 0 0 2.848zm3.325-.175a.75.75 0 0 0 1.047.175l2.36-1.686a1.75 1.75 0 0 0 0-2.848l-2.36-1.686a.75.75 0 0 0-.872 1.22l2.36 1.687c.14.1.14.306 0 .406l-2.36 1.687a.75.75 0 0 0-.175 1.045"/></svg>`,
};
