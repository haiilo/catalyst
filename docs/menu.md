...
The trigger is always a button with sensible defaults but fully configurable
...
| `triggerIconRight`        | `trigger-icon-right`   | Icon right flag for the trigger button.                                                                                                                                                              | `boolean \| undefined`                                                                                                                                               | `undefined`      |
...
| `triggerRound`            | `trigger-round`        | Round flag for the trigger button.                                                                                                                                                                   | `boolean \| undefined`                                                                                                                                               | `undefined`      |
